 ...
 * None. */
inline bool operator!(MoveDirectionX direction) { return direction == MoveDirectionX::None; }

/** @brief Unary plus operator to cast MoveDirectionX to its underlying uint8_t
 * value. */
inline constexpr uint8_t operator+(MoveDirectionX direction) { return static_cast<uint8_t>(direction); }

/** @brief Logical NOT operator for MoveDirectionY. Returns true if direction is
 * None. */
inline bool operator!(MoveDirectionY direction) { return direction == MoveDirectionY::None; }

/** @brief Unary plus operator to cast MoveDirectionY to its underlying uint8_t
 * value. */
inline constexpr uint8_t operator+(MoveDirectionY direction) { return static_cast<uint8_t>(direction); }

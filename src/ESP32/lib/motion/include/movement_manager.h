...
public:
     ...
     * @details Translates MoveDirectionX and MoveDirectionY into actuator actions.
     ...
     * @details Checks the MoveDirectionX enum; if Left or Right, the stepper moves by
     * the predefined _STEP_INCREMENT. Negative steps rotate in one direction, 

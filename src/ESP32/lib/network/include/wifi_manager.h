...
public:
     ...
     * @details Sets mode to WIFI_STA and disables sleep modes for better hardware stability.
     ...
     * @return String formatted IP (e.g. "192.168.1.50") or "0.0.0.0" if unavailable.
     */
    static String get_ip();

    /**
     * @brief Heartbeat function. Checks if WiFi has diconnected, if so, attempts to reconnect.

 ...
 * @brief An abstract base class (Interface) that defines the contract for detection algorithms.
 * This class allows the Controller to remain agnostic of the specific detection 
 * method (e.g., Color, AI, or Motion) by providing a consistent interface.
 */
class BaseDetectionModule
{
public:

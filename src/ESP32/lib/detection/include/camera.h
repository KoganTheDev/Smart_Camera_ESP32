...
namespace WroverPins {
    ...
    /** @brief Pixel Clock: Signals when the data on the Y pins is valid for capture. */
...
public:
     ...
     * @details Sets default values for QVGA resolution, JPEG format, and PSRAM usage.
     */
    Camera()
    {
     ...
     * @return true if initialization succeeded, false if sensor not found or PSRAM failed.
     */
    bool begin();
